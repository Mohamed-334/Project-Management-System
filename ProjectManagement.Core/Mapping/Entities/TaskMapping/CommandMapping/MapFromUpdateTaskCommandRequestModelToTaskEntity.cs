...
namespace ProjectManagement.Core.Mapping.TaskMapping
{
    ...
    {
        #region Methods
        public void MapFromUpdateTaskCommandRequestModelToTaskEntity()
        {
            CreateMap<UpdateTaskCommandRequestModel, TaskEntity>()
                ...
                .AfterMap<MetaMappingDataBasedOnDestination<UpdateTaskCommandRequestModel, TaskEntity>>();
        }
        #endregion
    }
}
