...
{
    public class AddProjectCommandValidator : AbstractValidator<AddProjectCommandRequestModel>
    {
        #region Fields
        ...
        #region Constructor
        public AddProjectCommandValidator(IStringLocalizer<AppLocalization> stringLocalizer, IProjectService projectService)
        {
